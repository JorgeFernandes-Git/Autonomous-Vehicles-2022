function [allData, scenario, sensors] = TP2_Cenario_2_mod()
%TP2_Cenario_2_mod - Returns sensor detections
%    allData = TP2_Cenario_2_mod returns sensor detections in a structure
%    with time for an internally defined scenario and sensor suite.
%
%    [allData, scenario, sensors] = TP2_Cenario_2_mod optionally returns
%    the drivingScenario and detection generator objects.

% Generated by MATLAB(R) 9.12 (R2022a) and Automated Driving Toolbox 3.5 (R2022a).
% Generated on: 16-Dec-2022 21:37:22
...
car7 = vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [-17.7 45.2 0], ...
    'Mesh', driving.scenario.carMesh, ...
    'Name', 'Car7');
waypoints = [-17.7 45.2 0;
    13.6 38.2 0;
    55.6 13.5 0;
    40.5 -62.8 0;
    40.3 -69.8 0;
...
pedestrian = actor(scenario, ...
    ...
    'Width', 0.45, ...
    'Height', 1.7, ...
    'Position', [92.4 -121.3 0], ...
    'RCSPattern', [-8 -8;-8 -8], ...
    'Mesh', driving.scenario.pedestrianMesh, ...
    'Name', 'Pedestrian');
waypoints = [92.4 -121.3 0;
    97.7 -108.9 0];
speed = [1.5;1.5];
